...
2. Confirm progress and plans against the private project Markdown and any live data source. Historical Linear records are read-only, not a status source.
